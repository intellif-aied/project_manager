...
func TestReportSkillMarkdownUsesReportBriefForPersonalDaily(t *testing.T) {
	...
	required := []string{
		...
		"Resolve work_evidence.threads and thread_refs as continuity hints, not headings",
		"First identify the shared reader-facing product, initiative, or business object",
		"one named system normally form one workstream",
		"Keep material documentation, Q&A, implementation, deployment, fixes, and validation as deliverables",
		"Session, repository, or thread alone neither forces merge nor split",
		"After subject-first grouping",
		...
		"is not production unless explicitly released to production users",
