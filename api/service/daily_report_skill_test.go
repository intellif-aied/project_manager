...
func TestReportSkillMarkdownUsesReportBriefForPersonalDaily(t *testing.T) {
	...
	required := []string{
		...
		"exact same ordered list for summary and content",
		"Do not add headings, detail paragraphs, nested lists",
		"Do not expand titles from deliverables or add commit, merge, test, deployment, release, environment, validation, recommendation",
		...
		"write one canonical Markdown ordered list",
