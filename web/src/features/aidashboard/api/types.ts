...
export interface TokenAnalyticsSessionItem {
  ...
  uncached_input_tokens: string | null;
  cache_read_tokens: string | null;
  cache_write_5m_tokens: string | null;
  cache_write_1h_tokens: string | null;
  output_tokens: string | null;
  self_total_tokens: string | null;
  subagent_total_tokens: string | null;
  family_total_tokens: string | null;
  lifetime_total_tokens: string | null;
  range_total_tokens: string | null;
  member_count: number;
